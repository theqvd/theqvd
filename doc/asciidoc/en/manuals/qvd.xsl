...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="doc.lot.show">figure</xsl:param>
  ...
  <!-- icon set -->
   <xsl:param name="figure.caution">../images/icons/caution.png</xsl:param>
   <xsl:param name="figure.important">../images/icons/important.png</xsl:param>
   <xsl:param name="figure.note">../images/icons/note.png</xsl:param>
   <xsl:param name="figure.tip">../images/icons/tip.png</xsl:param>
   <xsl:param name="figure.warning">../images/icons/warning.png</xsl:param>
