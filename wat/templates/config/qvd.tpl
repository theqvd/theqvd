<div class="wrapper-content <%= cid %> sec-qvd-config"> 
    ...
    <div class="setup-block">
        <div class="action-token-top">
            <a class="js-traductable_button js-button-new actions_button button fa fa-plus-circle" data-qvd-obj="config" name="btn-new-conf-token" data-i18n="New configuration token"></a>
