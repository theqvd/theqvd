Wat.Views.AdministratorRoleEditorView = Wat.Views.EditorView.extend({
    initialize: function(params) {
        this.extendEvents(this.commonEvents);
        
        Wat.Views.EditorView.prototype.initialize.apply(this, [params]);
    },
    
    commonEvents: {
        'click .js-assign-role-button': 'addRole',
        'click .js-delete-role-button': 'deleteRole',
    },
    
    addRole: function (e) {
        var roleId = $('select[name="role_to_be_assigned"]').val();
        
        this.editorAssignRole(roleId);
    },
    
    deleteRole: function (e) {
        var roleId = $(e.target).attr('data-id');
        
        this.editorDeleteRole(roleId);
    },
