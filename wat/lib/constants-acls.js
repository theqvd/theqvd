...
ACLS = {
    ...
    "my-admin-area.see-main.": "Access to logged administrator's area",
    "my-admin-area.update.columns": "Update visible columns on each list view",
    "my-admin-area.update.filters-desktop": "Update visible filters for list in desktop version",
    "my-admin-area.update.filters-mobile": "Update visible filters for list in mobile version",
    "my-admin-area.update.password": "Update password of logged administrator",
    ...
    "osf.see.vm-list-state": "Change OS Flavour's virtual machines' running state",
    ...
    "osf.update-massive.memory": "osf.update.memory (massive)",
