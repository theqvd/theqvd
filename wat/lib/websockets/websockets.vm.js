                            ...
                            if (expChanged) {
                                ...
                                var template = _.template(
                                    Wat.TPL.vmListExpiration, {
                                        ...
                                        expiration: Wat.U.databaseDateToString(model.get(field)),
                    ...
                    if (Wat.C.checkACL('vm.see.expiration')) {
                        ...
                        var template = _.template(
                            Wat.TPL.vmDetailsExpiration, {
                                expiration_soft: Wat.U.databaseDateToString(model.get('expiration_soft')),
                                expiration_hard: Wat.U.databaseDateToString(model.get('expiration_hard')),
