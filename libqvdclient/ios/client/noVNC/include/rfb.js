...
function constructor() {
    ...
    ws.on('open', function() {
        if (rfb_state === "connect") {
            updateState('ProtocolVersion', "Starting QVD handshake");
        } else {
    ...
    ws.on('close', function(e) {
        ...
        if (rfb_state === 'disconnect') {
            updateState('disconnected', 'QVD disconnected' + msg);
    ...
    if (Websock_native) {
        ...
        updateState('loaded', 'QVD ready: native WebSockets, ' + rmode);
    } else {
        ...
        if ((! Util.Flash) ||
            ...
            updateState('loaded', 'QVD ready: WebSockets emulation, ' + rmode);
        }
    }
