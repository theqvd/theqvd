Wat.L = {
    ...
    Login: function (that) {
        ...
        // Store tenant mode
        Wat.C.multitenant = parseInt(that.retrievedData.multitenant) || 1;
        
        // Store authentication separators
        Wat.C.authSeparators = that.retrievedData.auth ? that.retrievedData.auth.separators : SEPARATORS_DEFAULT;
        
        Wat.A.apiLogIn(Wat.L.checkLogin, Wat.C);
    },
