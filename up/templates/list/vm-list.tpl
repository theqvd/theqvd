        ...
        %>
            <tr class="row-<%= model.get('id') %>">
                <td class="js-name col-width-100">
                    <span class="bigtext bold vm-name"><%= model.get('name') %></span>
                    <div class="liltext">
                        <i class="desktop-state js-desktop-state" data-i18n="<%= connected ? 'Connected' : 'Disconnected' %>" data-id="<%= model.get('id') %>"></i>
                    </div>
                </td>
                <td>
                    <a class="<%= CLASS_ICON_CONF_SPECIFIC %> button2 js-vm-settings connect-btn js-connect-btn" data-id="<%= model.get('id') %>" data-i18n="Configure"></a>
                </td>
