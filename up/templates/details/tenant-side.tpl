<div class="side-component js-side-component1">
    <div class="side-header">
        ...
        <a class="button2 button-right fa fa-arrows-h" href="#/vms/<%= Up.U.transformFiltersToSearchHash({tenant_id: model.get('id')}) %>" data-i18n="Extended view"></a>
        <% } %>
    </div>
...
<div class="side-component js-side-component2">
    <div class="side-header">
        ...
        <% if (Up.C.checkACL('user.see-main.')) { %>
        <a class="button2 button-right fa fa-arrows-h" href="#/users/<%= Up.U.transformFiltersToSearchHash({tenant_id: model.get('id')}) %>" data-i18n="Extended view"></a>
        <% } %>
    </div>
...
<div class="side-component js-side-component3">
    <div class="side-header">
        ...
        <a class="button2 button-right fa fa-arrows-h" href="#/dis/<%= Up.U.transformFiltersToSearchHash({tenant_id: model.get('id')}) %>" data-i18n="Extended view"></a>
        <% } %>
    </div>
