<div class="side-component js-side-component1">
    <div class="side-header">
        ...
        <% if (Up.C.checkACL('log.see-main.') && model.get('object_id')) { %>
        <a class="button2 button-right fa fa-arrows-h" href="#/logs/<%= Up.U.transformFiltersToSearchHash({qvd_object: model.get('qvd_object'), object_id: model.get('object_id')}) %>" data-i18n="Extended view"></a>
        <% } %>
    </div>
