...
sub new {
    ...
    $ver_sizer->Add( Wx::HyperlinkCtrl->new( $panel , -1, 'Qindel Group '.chr(169).' 2020','http://theqvd.com',wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL , ''), 0 , wxALIGN_CENTER_HORIZONTAL, 5 );
