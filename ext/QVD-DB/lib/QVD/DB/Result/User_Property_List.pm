package QVD::DB::Result::User_Property_List;
use base qw/DBIx::Class/;

__PACKAGE__->load_components(qw/Core/);
__PACKAGE__->table('user_properties_list');
__PACKAGE__->add_columns( property_id   => { data_type => 'integer' } );

__PACKAGE__->set_primary_key('property_id');
__PACKAGE__->has_many(properties => 'QVD::DB::Result::User_Property', 'property_id', { cascade_delete => 0 });
