Name:           qvd-sample-config
Version:        3.1.0
Release:        %{_svn_rev}
Summary:        QVD Default config
License:        unknown
Group:          Development/Libraries
URL:            http://svn.int.qindel.com/repos/main/projects/qindel/QVD/src/trunk/ext/qvd-sample-config
...
cd $RPM_BUILD_DIR
svn co -r %{_svn_rev} http://svn.int.qindel.com/repos/main/projects/qindel/QVD/src/trunk/ext/qvd-sample-config
...
cd $RPM_BUILD_DIR/qvd-sample-config
