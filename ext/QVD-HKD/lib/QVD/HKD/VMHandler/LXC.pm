...
use Class::StateMachine::Declarative
    ...
    starting  => { advance => '_on_done',
                   ...
                   substates => [ saving_state    => { enter => '_save_state',
                                  ...
                                  clean_old       => { transitions => { _on_error => 'zombie/beat_to_death' },
    ...
    stopping  => { advance => '_on_done',
                   ...
                   substates => [ cmd      => { advance => '_on_error',
                                  ...
                                  cleanup  => { transitions => { _on_error => 'zombie/beat_to_death' },
                                                substates => [ saving_state           => { enter => '_save_state' },
                                  ...
                                  db       => { enter => '_clear_runtime_row',
                                                transitions => { _on_error => 'zombie/beat_to_death',
                                                                 _on_done  => 'stopped' } } ] },
    ...
    zombie  => { advance => '_on_done',
                 ...
                 substates => [ '(beat_to_death)'       => { enter => '_check_dirty_flag',
                                ...
                                idle                    => { enter => '_set_state_timer',
                                                             transitions => { _on_state_timeout => 'stopping_lxc',
                                                                              on_hkd_kill       => 'stopped' } } ] },
