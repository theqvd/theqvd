...
sub BUILD
{
    ...
    QVD::API::Exception->throw(code => 4110) if
	ref($name) || (not defined $name) || $name eq '';

    QVD::API::Exception->throw(code => 4100) 
...
# Returns the method of QVD::API that must be executed
# in order to execute the action. This method will be executed from
# another method in QVD::API::REST. The name of that other method 
...
# Returns the methods of QVD::API that must be
...
# Returns the method of QVD::API::REST that must be executed
